...
<title>訂閱網站_蘇老師</title>
    <style>
        ...
        .tech-card:hover .card{
            background-image: linear-gradient(60deg, #3d3393 0%, #2b76b9 37%, #2cacd1 65%, #35eb93 95%);
        ...
        .sup-card .card .card-header{
            color: #00FFFF;
        }
        .sup-card .card .card-body{
            color: #fff;
            transition: .2s;
        }
        .sup-card .card .card-footer button{
            width: 70%;
            margin-top: 15px;
            margin-bottom: 10px;
            padding: 10px;
        ...
        .sup-card:hover .card{
            ...
            background-image: linear-gradient(to bottom right, #0acffe 0%, #495aff 100%);
        }
        .sup-card:hover .card .card-header{
            color: #fff;
        }
        .sup-card:hover .card .card-body{
            text-shadow: 0.1em 0.2em 0.6em #2A2696;
        }
        .sup-card:hover .card .card-footer button{
            background: #ECFFFF;
            transform: scale(1.01);
            width: 100%;
    ...
    <div class="col-12 p-0 sticky-top" style="position:fixed">
        ...
        <div class="collapse navbar-collapse order-lg-1 order-3 mr-lg-0 " id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link text-light text-center pt-2" href="#technology"><h4 ><b>智能診股</b></h4></a>
                </li> 
            </ul>
        </div>
            <!---left--->
        ...
        <div class="collapse navbar-collapse order-lg-3 order-4" id="navbarNav">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link text-light text-center pt-2" href="#plan"><h4><b>方案介紹</b></h4></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-light text-center pt-2" href="#planpay"><h4><b>我要訂閱</b></h4></a>
                </li>
            </ul>
        </div>
            <!---right--->
...
<!---
  ...
  <script>
    ...
    <!---方案--->
    <div class="col-12 p-0 m-0" id="bg">
        <div id="plan"></div>
        <div class="container">
            <h6><br><br></h6>
            <h2 class="text-light text-center pb-3">訂閱內容</h2>
            ...
            <div class="card-deck">
                ...
                <div class="card text-light" style="border-width: 2px; border-color: #fff; ">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle mb-2 text-center">〈每週 1 篇〉</h6>
                ...
                <div class="card text-light " style="border-width: 2px; border-color: #fff;">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle mb-2 text-center">〈每月 1  ~ 2 篇〉</h6>
    ...
    <div class="col-12">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-4 sup-card">
                    <div class="card my-2">
                        <div class="card-header border-0 bg-transparent">
                            <h3 class="text-center"><b>方案價格</b></h3>
                        </div>
                        <div class="card-body text-center">
                            <h1><b>NT$18000/<b>年</b></b></h1>
                        </div>
                        <a href="signup.php">
                            <div class="card-footer bg-transparent border-0" >
                                <button type="button"><h4>立即購買</h4></button>
                            </div>
                        </a>
                    </div>
                </div>
        ...
        <div class="row justify-content-center text-light">
            <div class="col-12 ">
                <div class="container">
                    ...
                    <div class="row p-3">
                        <!---card01--->
                        <div class="col-12 col-md-3 tech-card" >
                            <div class="card border-light">
                                <div class="card-body">
                                    <h5 class="text-center">強大的分析能力</h5>
                                    <h6 class="text-light">◆ 利用人工智能和大數據分析技術，融合了大戶思想，從歷史價格、財務報表、新聞事件等多個角度揭示潛在的投資機會。而且多、空都能操作!獲利方式更多元</h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-3 tech-card">
                            <div class="card border-light">
                                <div class="card-body">
                                    <h5 class="text-center">精準的買點預測</h5>
                                    <h6 class="text-light">◆ 通過複雜的算法和模型，它能夠識別股票價格的趨勢，並以直觀的方式呈現買點預測。無需專業知識，即可掌握投資時機。</h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-3 tech-card">
                            <div class="card border-light" >
                                <div class="card-body">
                                    <h5 class="text-center">自動學習和優化</h5>
                                    <h6 class="text-light">◆ 智能診股黑科技不斷學習和優化自身，您無需繁瑣的設置，系統會自動適應市場變化，確保您在市場上能穩健的獲利。</h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-3 tech-card">
                            <div class="card border-light">
                                <div class="card-body">
                                    <h5 class="text-center">提供支援和指引</h5>
                                    <h6 class="text-light">◆ 不論您是新手投資者還是有經驗的交易者，它能夠根據您的投資偏好和目標，提供直觀的投資建議，讓您更自信地在市場中行動。</h6>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="footer" style="background-color:#000">
        <div class="row justify-content-center">
            <div class="col-10 col-md-6 text-light">
                <h6><br><br><br></h6>
                            <!---form--->
            <h5 class="text-light text-center">大三元 ─ 諮詢表單</h5>
            <div class="row justify-content-center">
                <div class="col-12 col-md-8">
                    <form>
                        <div class="form-group">
                            <label for="exampleInputEmail1">客戶姓名</label>
                            <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="請填寫姓名">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">客戶電話</label>
                            <input type="password" class="form-control" id="exampleInputPassword1" placeholder="請填寫電話">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">客戶信箱</label>
                            <input type="password" class="form-control" id="exampleInputPassword1" placeholder="請填寫信箱">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">有話對我們說：</label>
            ...
            <!---pic--->
            <div class="col-12 col-md-6" style="justify-content: center; align-item:center">
                <h6><br><br><br><br><br></h6>
                <div class="col-12 col-md-10">
                    <img src="image_shu/00.png" style="max-width: 100%;">
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6">
                <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSfuoHEsNi2zjXoheOrObwHN-nWQD07_8f82KDdtzdhGmdBKxA/viewform?embedded=false" width="100%" height="800" frameborder="0" marginheight="0" marginwidth="0" >載入中…</iframe>
            </div>
        </div>--->
        <!---text--->
        <div class="row m-2">
            ...
            <div class="col-12 col-md-6">
                <p class="text-light">關於我們</p>
                <p class="text-light">客服專區</p>
            </div>
        </div>
        <div class="col-12" >
        ...
        <div class="col-12 m-0 d-flex justify-content-center align-items-center" style="background-color:#000; height: 50px">
            <h6 class="text-center text-light m-0">啟發證券版權所有Copyright © 2023</h6>
        </div>
    </div>
</body>
</html>