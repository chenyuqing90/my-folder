...
(個股推薦：黑馬股 波段股 價值股)
       ...
       <!---swiper item E--->  
        <div class="swiper-slide slider-item">
          ...
          <div class="swiper-slide-content">
              ...
              <div class="content-title">月營收績優股</div>
      
              <div class="content-text">從威元老師的選股清單中，統整出當月基本面良好的績優股。
              </div>
       ...
       <!---swiper item F--->  
        <div class="swiper-slide slider-item">
          <!---swiper-item-img--->
          <div class="swiper-slide-image">
              <img src="image_shu/people-06.jpg">
          </div>
          <!---swiper-item-content-->
          <div class="swiper-slide-content">
              <!---
              ...
              <div class="content-title">股東(法說)會</div>
      
              <div class="content-text">公司派時常在法說會發表重要言論，但繁雜資訊過於混亂，威元老師直接整理關鍵內容給你。
              </div>
       ...
       <!---swiper item G--->  
        <div class="swiper-slide slider-item">
          <!---swiper-item-img--->
          <div class="swiper-slide-image">
              <img src="image_shu/digital-07.jpg">
          </div>
          <!---swiper-item-content-->
          <div class="swiper-slide-content">
              <!---
              ...
              <div class="content-title">技術籌碼教學</div>
      
              <div class="content-text">為了協助投資人獨立判斷進(出)場時間，會以舉例的形式說明，當持股出現同樣跡象就可以作為應用。
              </div>
        ...
        <div class="container">
            ...
            <div class="card-deck">
                <div class="card text-light " style="border-width: 2px; border-color: #fff; ">
                    <div class="card-body">
                        <h5 class="card-title"><b>盤勢解析與個股推薦</b></h5>
                        <h6 class="card-subtitle mb-2"><i>(每個交易日)</i></h6>
                        <p class="card-text">針對大盤多空分析及熱門個股與黑馬個股行深度掃描，
                                提供交易策略教學與支撐壓力點位。在基本面的基礎上，搭配大戶動態及技術面型態，
                                看出短期具有催化劑的績優股！</p>
                ...
                <div class="card text-light" style="border-width: 2px; border-color: #fff; ">
                    <div class="card-body">
                        <h5 class="card-title"><b>第一手產業研究報告</b></h5>
                        <h6 class="card-subtitle mb-2"><i>(每週一篇)</i></h6>
                        <p class="card-text">每個月從熱門產業趨勢中，發掘營運具基本面及爆發性的績優股。</p>
                           
                    </div>
                </div>
                <div class="card text-light " style="border-width: 2px; border-color: #fff;">
                    <div class="card-body">
                        <h5 class="card-title"><b>股東(法說)會+月營收績優股</b></h5>
                        <h6 class="card-subtitle mb-2"><i>(每月一 ~ 二篇)</i></h6>
                        <p class="card-text">公司派時常在法說會發表重要言論，但繁雜資訊過於混亂，威元老師直接整理
                                關鍵內容給你。並統整出當月營收良好的績優股。</p>
                           
                    </div>
                </div>
                <div class="card text-light " style="border-width: 2px; border-color: #fff;">
                    <div class="card-body">
                        <h5 class="card-title"><b>獨家技術教學</b></h5>
                        <h6 class="card-subtitle mb-2"><i>(每月一 ~ 二篇)</i></h6>
                        <p class="card-text">協助投資人獨立判斷進、出場時間，會以舉例的形式說明，
                                當持股出現同樣跡象就可以作為應用。</p>
